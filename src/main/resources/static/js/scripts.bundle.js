  ...
  var e = function (e) {
    ...
    i = function () {
      $('[data-portlet="true"]').each(function () {
        var e = $(this);
        !0 !== e.data("portlet-initialized") &&
          (o(e, {}), e.data("portlet-initialized", !0));
      });
    },
    l = function () {
      $('[data-scrollable="true"]').each(function () {
        ...
        mUtil.isInResponsiveRange("tablet-and-mobile")
          ? ((e = a.data("mobile-max-height")
              ? a.data("mobile-max-height")
              : a.data("max-height")),
            (t = a.data("mobile-height")
              ? a.data("mobile-height")
              : a.data("height")))
          : ((e = a.data("max-height")), (t = a.data("max-height"))),
      ...
      var t = mUtil.getUniqueID("App_alert"),
        a =
          ...
          (e.close
            ...
            : "") +
          ("" !== e.icon
            ? '<i class="fa-lg fa fa-' + e.icon + '"></i>  '
            : "") +
          e.message +
          "</div>";
      return (
        e.reset && $(".custom-alerts").remove(),
        e.container
          ? "append" == e.place
            ? $(e.container).append(a)
            : $(e.container).prepend(a)
          ...
          : $(".page-bar").size() > 0
          ? $(".page-bar").after(a)
          : $(".page-breadcrumb, .breadcrumbs").after(a),
    ...
    block: function (e, t) {
      ...
      if (
        ...
        (t = $.extend(
          ...
          ? (o =
              '<div class="m-spinner ' +
              (a = t.skin ? "m-spinner--skin-" + t.skin : "") +
              " " +
              (n = t.state ? "m-spinner--" + t.state : "") +
              '"></div')
          : ((a = t.skin ? "m-loader--skin-" + t.skin : ""),
        ...
        (html =
          ...
          o +
          "</span></div>"),
          (t.width = mUtil.realWidth(html) + 10),
          "body" == e &&
            (html =
              '<div class="' +
              l +
  ...
  return {
    ...
    isInResponsiveRange: function (e) {
      ...
      return (
        ...
        ("desktop-and-tablet" == e && t >= this.getBreakpoint("md") + 1) ||
        ("tablet-and-mobile" == e && t <= this.getBreakpoint("lg"))
      );
    },
...
$(document).ready(function () {
      ...
      if (!e(this).hasClass("m-datatable--loaded")) {
        ...
        var n = {
          ...
          init: function (t) {
            return (
              n.setupBaseDOM.call(),
              n.setupDOM(a.table),
              o.setDataSourceQuery(
                o.getOption("data.source.read.params.query")
              ),
              ...
              ("remote" !== t.data.type && "local" !== t.data.type) ||
                ((!1 === t.data.saveState ||
                  (!1 === t.data.saveState.cookie &&
                    !1 === t.data.saveState.webstorage)) &&
                  n.stateRemove(n.stateId),
                "local" === t.data.type &&
                  "object" == typeof t.data.source &&
                  (null === t.data.source && n.extractTable(),
                  (a.jsonData = n.dataMapCallback(t.data.source))),
                n.dataRender()),
              n.setHeadTitle.call(),
              n.setHeadTitle.call(this, a.tableFoot),
              null === t.data.type &&
              ...
              void 0 !== t.layout.header &&
                !1 === t.layout.header &&
                e(a.table).find("thead").remove(),
              void 0 !== t.layout.footer &&
                !1 === t.layout.footer &&
                e(a.table).find("tfoot").remove(),
              (null !== t.data.type && "local" !== t.data.type) ||
                n.layoutUpdate(),
              e(window).resize(n.fullRender),
              e(a).height(""),
              e(o.getOption("search.input")).on("keyup", function (t) {
            ...
            var o = {
              ...
              init: function () {
                (o.lockEnabled = e.grep(t.columns, function (e, t) {
                  ...
                  0 !== o.lockEnabled.length &&
                    (n.isLocked() || (a.oriTable = e(a.table).clone()),
                    o.enable());
              },
              enable: function () {
                var t = function (t) {
                  ...
                  if (0 !== i.left.length || 0 !== i.right.length)
                    if (e(t).find(".m-datatable__lock").length > 0)
                      n.log("Locked container already exist in: ", t);
                    else if (0 !== e(t).find(".m-datatable__row").length) {
                      var l = e("<div/>").addClass(
                          ...
                          e(this)
                            ...
                            .each(function () {
                              ...
                              void 0 !== o
                                ? ((void 0 === o.left && !0 !== o) ||
                                    e(this).appendTo(t),
                                  void 0 !== o.right && e(this).appendTo(n))
                                : e(this).appendTo(a);
                            }),
                            e(this).remove();
                        }),
                        i.left.length > 0 &&
                          (e(a.wrap).addClass("m-datatable--lock"),
                          e(l).appendTo(t)),
                        (i.left.length > 0 || i.right.length > 0) &&
                          e(r).appendTo(t),
                        i.right.length > 0 &&
                          (e(a.wrap).addClass("m-datatable--lock"),
                          e(s).appendTo(t));
                ...
                e(a.table)
                  ...
                  .each(function () {
                    var a = this;
                    0 === e(this).find(".m-datatable__lock").length &&
              ...
              lockEnabledColumns: function () {
                ...
                return (
                  e.each(n, function (e, t) {
                    void 0 !== t.locked &&
                      (void 0 !== t.locked.left &&
                        mUtil.getBreakpoint(t.locked.left) <= a &&
                        o.left.push(t.locked.left),
                      void 0 !== t.locked.right &&
                        mUtil.getBreakpoint(t.locked.right) <= a &&
                        o.right.push(t.locked.right));
                  }),
                  o
                );
              },
          ...
          fullRender: function () {
            if (
              ...
              t.length > 0 &&
                (e(a.wrap).removeClass("m-datatable--lock"),
                e(a.table).empty().html(t),
                (a.oriTable = null),
                n.setupCellField.call(),
                o.redraw()),
                n.updateTableComponents.call();
            }
            n.insertData();
          },
          afterRender: function (t, i) {
            i.table === e(a.table).attr("id") &&
              (n.isLocked() || o.redraw(),
              e(a).ready(function () {
                e(a.tableBody)
          ...
          adjustLockContainer: function () {
            ...
            return (
              e(a.table).find(".m-datatable__lock--scroll").css("width", l), l
            );
          },
          dragResize: function () {
            var t,
          ...
          setupBaseDOM: function () {
            (a.old = e(a).clone()),
              "TABLE" === e(a).prop("tagName")
                ? ((a.table = e(a)
                    .removeClass("m-datatable")
                    .addClass("m-datatable__table")),
                  0 === e(a.table).parents(".m-datatable").length &&
                    (a.table.wrap(
                      e("<div/>")
                        .addClass("m-datatable")
                        .addClass("m-datatable--" + t.layout.theme)
                    ),
                    (a.wrap = e(a.table).parent())))
                : ((a.wrap = e(a)
                    .addClass("m-datatable")
                    .addClass("m-datatable--" + t.layout.theme)),
                  (a.table = e("<table/>")
              ...
              o.getOption("layout.height") &&
                e(a.table).css("max-height", o.getOption("layout.height")),
              null === t.data.type &&
                e(a.table).css("width", "").css("display", ""),
              (a.tableHead = e(a.table).find("thead")),
              0 === e(a.tableHead).length &&
                (a.tableHead = e("<thead/>").prependTo(a.table)),
              (a.tableBody = e(a.table).find("tbody")),
              0 === e(a.tableBody).length &&
                (a.tableBody = e("<tbody/>").appendTo(a.table)),
              void 0 !== t.layout.footer &&
                t.layout.footer &&
                ((a.tableFoot = e(a.table).find("tfoot")),
                0 === e(a.tableFoot).length &&
                  (a.tableFoot = e("<tfoot/>").appendTo(a.table)));
          },
                  ...
                  e(i)
                    ...
                    .each(function (t, a) {
                      ...
                      if (void 0 !== o && void 0 !== o.template) {
                        var i = "";
                        "string" == typeof o.template &&
                          (i = n.dataPlaceholder(o.template, r)),
                          "function" == typeof o.template &&
                            (i = o.template(r));
                        var s = e("<span/>").append(i);
                        e(a).html(s),
                          void 0 !== o.overflow &&
                            e(s).css("overflow", o.overflow);
                      }
                    });
              });
          },
                    ...
                    .each(function (t, a) {
                      ...
                      if (void 0 !== i) {
                        ...
                        if (void 0 !== i.selector && !1 !== i.selector) {
                          if (
                            e(a).find('.m-checkbox [type="checkbox"]').length >
                            0
                          )
                            return;
                          ...
                          void 0 !== i.selector.class &&
                            e(r).addClass(i.selector.class),
                            e(a).children().html(r);
                        }
                        if (void 0 !== i.subtable && i.subtable) {
                          if (
                            e(a).find(".m-datatable__toggle-subtable").length >
                            0
                          )
                            return;
                          e(a)
              ...
              var i = function (t) {
                ...
                if (
                  ...
                  void 0 !== a.selector.class &&
                    e(l).addClass(a.selector.class),
                    e(i).children().html(l);
                }
              };
              void 0 !== t.layout.header &&
                !0 === t.layout.header &&
                i(e(a.tableHead).find(".m-datatable__row").first()),
                void 0 !== t.layout.footer &&
                  !0 === t.layout.footer &&
                  i(e(a.tableFoot).find(".m-datatable__row").first());
            }
          },
          ...
          adjustCellsHeight: function () {
            e(a.table).find(".m-datatable__row"),
          ...
          setupDOM: function (t) {
            e(t).find("> thead").addClass("m-datatable__head"),
              ...
              e(t)
                .find("tr > th, tr > td")
                .each(function (t, a) {
                  0 === e(a).find("span").length &&
                    e(a).wrapInner(e("<span/>").width(n.offset));
                });
          },
          scrollbar: function () {
            var i = {
              ...
              init: function () {
                ...
                if (t.layout.scroll) {
                  ...
                  e(o).length > 0
                    ? ((i.scrollHead = e(a.tableHead).find(
                        "> .m-datatable__lock--scroll > .m-datatable__row"
                      )),
                      (i.scrollFoot = e(a.tableFoot).find(
                        "> .m-datatable__lock--scroll > .m-datatable__row"
                      )),
                      (i.tableLocked = e(a.tableBody).find(
                        ".m-datatable__lock:not(.m-datatable__lock--scroll)"
                      )),
                      n > mUtil.getBreakpoint("lg")
                        ? i.mCustomScrollbar(o)
                        : i.defaultScrollbar(o))
                    : ((i.scrollHead = e(a.tableHead).find(
                        "> .m-datatable__row"
                      )),
                      (i.scrollFoot = e(a.tableFoot).find(
                      ...
                      n > mUtil.getBreakpoint("lg")
                        ? i.mCustomScrollbar(a.tableBody)
                        : i.defaultScrollbar(a.tableBody));
                } else
                  e(a.table).css("height", "auto").css("overflow-x", "auto");
              },
              defaultScrollbar: function (t) {
                e(t)
                  .css("overflow", "auto")
                  .css("max-height", o.getOption("layout.height"))
                  .on("scroll", i.onScrolling);
              },
              onScrolling: function (t) {
                var a = e(this).scrollLeft(),
                  n = e(this).scrollTop();
                e(i.scrollHead).css("left", -a),
                  e(i.scrollFoot).css("left", -a),
                  e(i.tableLocked).each(function (t, a) {
                    e(a).css("top", -n);
                  });
              },
                ...
                var r = e.extend({}, i.mcsOptions, {
                  ...
                  callbacks: {
                    whileScrolling: function () {
                      var t = this.mcs;
                      e(i.scrollHead).css("left", t.left),
                        e(i.scrollFoot).css("left", t.left),
                        e(i.tableLocked).each(function (a, n) {
                          e(n).css("top", t.top);
                        });
                    },
                  },
                });
                !0 === o.getOption("layout.smoothScroll.scrollbarShown") &&
                  e(t).attr("data-scrollbar-shown", "true"),
          ...
          mCustomScrollbar: function (t, n) {
            e(a.tableBody).css("overflow", ""),
              0 === e(t).find(".mCustomScrollbar").length &&
                (e(a.tableBody).hasClass("mCustomScrollbar") &&
                  e(a.tableBody).mCustomScrollbar("destroy"),
                e(t).mCustomScrollbar(n));
          },
          setHeadTitle: function (o) {
            ...
            0 === e(l).length && (l = e("<tr/>").appendTo(o)),
              e.each(i, function (t, n) {
                var o = e(r).eq(t);
                if (
                  (0 === e(o).length && (o = e("<th/>").appendTo(l)),
                  void 0 !== n.title &&
                    e(o).html(n.title).attr("data-field", n.field).data(n),
                  void 0 !== n.textAlign)
                ) {
                  var i =
          ...
          dataRender: function (i) {
            ...
            var l = function () {
                ...
                0 === i.perpage && (i.perpage = t.data.pageSize || 10),
                  (i.total = a.jsonData.length);
                var l = Math.max(i.perpage * (i.page - 1), 0),
                  r = Math.min(l + i.perpage, i.total);
                return (a.jsonData = e(a.jsonData).slice(l, r)), i;
              },
              r = function (o) {
                e(a.wrap).removeClass("m-datatable--error"),
                  t.pagination
                    ? t.data.serverPaging && "local" !== t.data.type
                      ? n.paging(n.getObject("meta", o || null))
                      : n.paging(l(), function (t, o) {
                          e(t.pager).hasClass("m-datatable--paging-loaded") ||
                          ...
                          n.localDataUpdate(),
                            (a.jsonData = e(a.jsonData).slice(i, l)),
                            n.insertData();
                        })
                    : n.localDataUpdate(),
                  n.insertData();
            ...
            "local" === t.data.type ||
            (void 0 === t.data.source.read && null !== a.jsonData) ||
            (!1 === t.data.serverSorting && "sort" === i)
              ? r()
              : n.getData().done(r);
          },
          insertData: function () {
            ...
            e.each(a.jsonData, function (n, o) {
              for (
                var r = e("<tr/>").attr("data-row", n).data("obj", o),
                  s = 0,
                  d = [],
                  c = t.columns.length,
                  u = 0;
                ...
                var m = t.columns[u],
                  p = [];
                if (
                  (i.sort.field === m.field &&
                    p.push("m-datatable__cell--sorted"),
                  void 0 !== m.textAlign)
                ) {
                  var f =
                    void 0 !== a.textAlign[m.textAlign]
                      ? a.textAlign[m.textAlign]
                      : "";
                  p.push(f);
                }
                (d[s++] = '<td data-field="' + m.field + '"'),
                  (d[s++] = ' class="' + p.join(" ") + '"'),
                  (d[s++] = ">"),
                  (d[s++] = o[m.field]),
                  (d[s++] = "</td>");
              ...
              0 === a.jsonData.length &&
                (e("<span/>")
                  ...
                  .width("100%")
                  .html(o.getOption("translate.records.noRecords"))
                  .appendTo(l),
                e(a.wrap).addClass("m-datatable--error")),
              e(a.tableBody).replaceWith(l),
              (a.tableBody = l),
              n.setupDOM(a.table),
          ...
          getData: function () {
            ...
            return (
              "local" === t.data.type && (i.url = t.data.source),
              "remote" === t.data.type &&
                ((i.url = o.getOption("data.source.read.url")),
                "string" != typeof i.url &&
                  (i.url = o.getOption("data.source.read")),
                "string" != typeof i.url &&
                  (i.url = o.getOption("data.source")),
                (i.headers = o.getOption("data.source.read.headers")),
                (i.data.datatable = o.getDataSourceParam()),
                (i.method = o.getOption("data.source.read.method") || "POST"),
                o.getOption("data.serverPaging") ||
                  delete i.data.datatable.pagination,
                o.getOption("data.serverSorting") ||
                  delete i.data.datatable.sort),
              e
                .ajax(i)
                .done(function (t, o, i) {
                  (a.jsonData = n.dataMapCallback(t)),
                    e(a).trigger("m-datatable--on-ajax-done", [a.jsonData]);
                })
                .fail(function (t, n, i) {
                  e(a).trigger("m-datatable--on-ajax-fail", [t]),
                    e("<span/>")
                      ...
                      .width("100%")
                      .html(o.getOption("translate.records.noRecords"))
                      .appendTo(a.tableBody),
                    e(a).addClass("m-datatable--error");
                })
                .always(function () {})
            );
          },
          paging: function (t, i) {
            var l = {
              ...
              init: function (t) {
                (l.meta = t),
                  (l.meta.pages = Math.max(
                    Math.ceil(l.meta.total / l.meta.perpage),
                    1
                  )),
                  l.meta.page > l.meta.pages && (l.meta.page = l.meta.pages),
                  (l.paginateEvent = n.getTablePrefix()),
                  (l.pager = e(a.table).siblings(".m-datatable__pager")),
                  e(l.pager).hasClass("m-datatable--paging-loaded") ||
                    (e(l.pager).remove(),
                    0 !== l.meta.pages &&
                      (o.setDataSourceParam("pagination", l.meta),
                      (l.callback = l.serverCallback),
                      "function" == typeof i && (l.callback = i),
                      l.addPaginateEvent(),
                      l.populate(),
                      (l.meta.page = Math.max(l.meta.page || 1, l.meta.page)),
                      e(a).trigger(l.paginateEvent, l.meta),
                      l.pagingBreakpoint.call(),
                      e(window).resize(l.pagingBreakpoint)));
              },
              ...
              populate: function () {
                  ...
                  e("<li/>")
                    .append(
                      e("<a/>")
                        ...
                        .append(e("<i/>").addClass(t.first))
                        .on("click", l.gotoMorePage)
                        .attr("data-page", 1)
                    )
                    .appendTo(i),
                  e("<li/>")
                  ...
                  e("<li/>")
                    .append(
                      e("<a/>")
                        ...
                        .append(e("<i/>").addClass(t.last))
                        .on("click", l.gotoMorePage)
                        .attr("data-page", l.meta.pages)
                    )
                    .appendTo(i),
                  o.getOption("toolbar.items.info") &&
                    (l.pagerLayout.info = e("<div/>")
                      .addClass("m-datatable__pager-info")
                      .append(
                        e("<span/>").addClass("m-datatable__pager-detail")
                      )),
                  e.each(o.getOption("toolbar.layout"), function (t, a) {
                ...
                var m = e("<select/>")
                  ...
                  .val(l.meta.perpage)
                  .on("change", l.updatePerpage)
                  .prependTo(l.pagerLayout.info);
                e.each(
                  o.getOption("toolbar.items.pagination.pageSizeSelect"),
                  function (t, a) {
                    var n = a;
                    -1 === a && (n = "All"),
                      e("<option/>").attr("value", a).html(n).appendTo(m);
                  }
                ),
                  e(a).ready(function () {
                    e(".selectpicker")
              ...
              paste: function () {
                e.each(
                  e.unique(o.getOption("toolbar.placement")),
                  function (t, n) {
                    "bottom" === n && e(l.pager).clone(!0).insertAfter(a.table),
                      "top" === n &&
                        e(l.pager)
                          .clone(!0)
              ...
              gotoMorePage: function (t) {
                if (
                  (t.preventDefault(), "disabled" === e(this).attr("disabled"))
                )
                  return !1;
                var a = e(this).attr("data-page");
                return (
                  void 0 === a && (a = e(t.target).attr("data-page")),
              ...
              gotoPage: function (t) {
                t.preventDefault(),
                  e(this).hasClass("m-datatable__pager-link--active") ||
                    l.openPage(parseInt(e(this).data("page")));
              },
              openPage: function (t) {
                (l.meta.page = parseInt(t)),
                  e(a).trigger(l.paginateEvent, l.meta),
                  l.callback(l, l.meta),
                  e(l.pager).trigger("m-datatable--on-goto-page", l.meta);
              },
              updatePerpage: function (t) {
                t.preventDefault(),
                  null === o.getOption("layout.height") &&
                    e("html, body").animate({ scrollTop: e(a).position().top }),
                  (l.pager = e(a.table)
                    .siblings(".m-datatable__pager")
                    .removeClass("m-datatable--paging-loaded")),
                  t.originalEvent && (l.meta.perpage = parseInt(e(this).val())),
                  e(l.pager)
                    .find("select.m-datatable__pager-size")
                    .val(l.meta.perpage)
                    .attr("data-selected", l.meta.perpage),
                  o.setDataSourceParam("pagination", l.meta),
                  e(l.pager).trigger("m-datatable--on-update-perpage", l.meta),
                  e(a).trigger(l.paginateEvent, l.meta),
                  l.callback(l, l.meta),
                  l.updateInfo.call();
              },
              addPaginateEvent: function (t) {
                e(a)
                  .off(l.paginateEvent)
                  .on(l.paginateEvent, function (t, i) {
                    n.spinnerCallback(!0),
                      (l.pager = e(a.table).siblings(".m-datatable__pager"));
                    ...
                    e(r)
                      ...
                      e(r)
                        ...
                        .attr("data-page", Math.max(i.page - 1, 1)),
                      e(r)
                        .find(".m-datatable__pager-link--next")
                        .attr("data-page", Math.min(i.page + 1, i.pages)),
                      e(l.pager).each(function () {
                        e(this)
                          .find('.m-pager-input[type="text"]')
                          .prop("value", i.page);
                      }),
                      e(l.pager).find(".m-datatable__pager-nav").show(),
                      i.pages <= 1 &&
                        e(l.pager).find(".m-datatable__pager-nav").hide(),
                      o.setDataSourceParam("pagination", l.meta),
                      e(l.pager)
                        .find("select.m-datatable__pager-size")
                        .val(i.perpage)
                        .attr("data-selected", i.perpage),
                      e(a.table)
              ...
              updateInfo: function () {
                ...
                e(l.pager)
                  ...
                  .html(
                    n.dataPlaceholder(
                      o.getOption("translate.toolbar.pagination.items.info"),
                      {
                        start: t,
                        end: -1 === l.meta.perpage ? l.meta.total : a,
                        pageSize:
                          -1 === l.meta.perpage ||
                          l.meta.perpage >= l.meta.total
                            ? l.meta.total
                            : l.meta.perpage,
                        total: l.meta.total,
                      }
              ...
              pagingBreakpoint: function () {
                ...
                if (0 !== e(t).length) {
                  ...
                  e(t).find("li").show(),
                    e.each(
                      o.getOption("toolbar.items.pagination.pages"),
                      function (a, r) {
                        if (mUtil.isInResponsiveRange(a)) {
                          switch (a) {
                            case "desktop":
                            case "tablet":
                              Math.ceil(n / r.pagesNumber),
                                r.pagesNumber,
                                r.pagesNumber;
                              e(i).hide(),
                                (l.meta = o.getDataSourceParam("pagination")),
                                l.paginationUpdate();
                              break;
                            case "mobile":
                              e(i).show(),
              ...
              paginationUpdate: function () {
                ...
                e(i).each(function (t, a) {
                  ...
                  p === l.meta.pages && p === e(u).last().data("page")
                    ? e(i).parent().hide()
                    : e(i).parent().show(),
                  1 === l.meta.page
                    ? (e(r)
          ...
          columnHide: function () {
            ...
            e.each(t.columns, function (t, o) {
              if (void 0 !== o.responsive) {
                var i = o.field,
                  l = e.grep(
                    e(a.table).find(".m-datatable__cell"),
                    function (t, a) {
          ...
          setupSubDatatable: function () {
            ...
            if ("function" == typeof i) {
              ...
              var l = function (n) {
                  ...
                  e(r).is(":hidden")
                    ? (e(d).addClass(
                        o.getOption("layout.icons.rowDetail.collapse")
                      ),
                      e(l).removeClass("m-datatable__row--detail-expanded"),
                      e(a).trigger("m-datatable--on-collapse-detail", [l]))
                    : (e(d).addClass(
                        o.getOption("layout.icons.rowDetail.expand")
                      ),
                      e(l).addClass("m-datatable__row--detail-expanded"),
                      e(a).trigger("m-datatable--on-expand-detail", [l]),
                      e.map(a.jsonData, function (e, a) {
                        return (
                          s === e[t.columns[0].field] && ((n.data = e), !0)
                        );
                      }),
                      (n.detailCell = e(r).find(".m-datatable__detail")),
                      0 === e(n.detailCell).find(".m-datatable").length &&
                        i(n));
                },
                r = t.columns;
              e(a.tableBody)
                          ...
                          e(a)
                            ...
                            .html(
                              e("<a/>")
                                ...
                                .attr("href", "#")
                                .attr("data-value", i)
                                .attr("title", o.getOption("detail.title"))
                                .on("click", l)
                                .append(
                                  e("<i/>").addClass(
                                    o.getOption(
                ...
                e(a.tableBody)
                  ...
                  .each(function () {
                    ...
                    e(this).after(t),
                      e(this).hasClass("m-datatable__row--even") &&
                        e(t).addClass("m-datatable__row-detail--even");
                  });
            }
          },
          ...
          spinnerCallback: function (e) {
            if (e) {
              if (!n.isSpinning) {
                ...
                !0 === t.message &&
                  (t.message = o.getOption("translate.records.processing")),
                  (n.isSpinning = !0),
          ...
          replaceTableContent: function (t, n) {
            void 0 === n && (n = a.tableBody),
              e(n).hasClass("mCustomScrollbar")
                ? e(n).find(".mCSB_container").html(t)
                : e(n).html(t);
          },
          getExtraSpace: function (t) {
            return (
              ...
              (parseInt(e(t).css("marginRight")) +
                parseInt(e(t).css("marginLeft"))) +
              Math.ceil(e(t).css("border-right-width").replace("px", ""))
            );
          },
          ...
          getTablePrefix: function (e) {
            return (
              void 0 !== e && (e = "-" + e),
              "m-datatable__" + n.getTableId() + "-" + n.getDepth() + e
            );
          },
          getDepth: function () {
            var t = 0,
          ...
          stateKeep: function (e, t) {
            (e = n.getTablePrefix(e)),
              !1 !== o.getOption("data.saveState") &&
                (o.getOption("data.saveState.webstorage") &&
                  localStorage &&
                  localStorage.setItem(e, JSON.stringify(t)),
                o.getOption("data.saveState.cookie") &&
                  Cookies.set(e, JSON.stringify(t)));
          },
          stateGet: function (e, t) {
            if (
              ((e = n.getTablePrefix(e)), !1 !== o.getOption("data.saveState"))
            ) {
              var a = null;
              return void 0 !==
                (a =
                  o.getOption("data.saveState.webstorage") && localStorage
                    ? localStorage.getItem(e)
                    : Cookies.get(e)) && null !== a
                ? JSON.parse(a)
                : void 0;
            }
          },
          ...
          getTotalColumns: function (t) {
            return (
              ...
              e(t).find(".m-datatable__row").first().find(".m-datatable__cell")
                .length
            );
          },
              ...
              init: function () {
                t.sortable &&
                  (e(a.tableHead)
                    ...
                    .off("click")
                    .on("click", i.sortClick),
                  i.setIcon());
              },
              setIcon: function () {
                var t = o.getDataSourceParam("sort"),
                  n = e(a.tableHead)
                    .find('.m-datatable__cell[data-field="' + t.field + '"]')
                    .attr("data-sort", t.sort),
                  i = e(n).find("span"),
                  l = e(i).find("i"),
                  r = o.getOption("layout.icons.sort");
                e(l).length > 0
                  ? e(l).removeAttr("class").addClass(r[t.sort])
                  : e(i).append(e("<i/>").addClass(r[t.sort]));
              },
              sortClick: function (l) {
                ...
                if (
                  ...
                  r.field === s && (c = r.sort),
                    ...
                    o.setDataSourceParam("sort", r),
                    i.setIcon(),
                    setTimeout(function () {
                      n.dataRender("sort"),
                        e(a).trigger("m-datatable--on-sort", r);
                    }, 300);
                }
              },
            };
          ...
          localDataUpdate: function () {
            ...
            if (
              (void 0 !== r
                ? "function" == typeof r.sortCallback
                  ? (a.jsonData = r.sortCallback(a.fullJsonData, l, r))
                  : (a.jsonData = n.sortCallback(a.fullJsonData, l, r))
                : (a.jsonData = a.fullJsonData),
              ...
              void 0 !== s &&
                "" !== s &&
                ((s = s.toLowerCase()),
                (a.jsonData = e.grep(a.jsonData, function (e) {
                  for (var t in e)
                    if (
                      e.hasOwnProperty(t) &&
                      "string" == typeof e[t] &&
                      e[t].toLowerCase().indexOf(s) > -1
                    )
                      return !0;
                  return !1;
                })),
                ...
                (a.jsonData = n.filterArray(a.jsonData, t.query)),
                (a.jsonData = a.jsonData.filter(function () {
                  return !0;
                }));
            }
            return a.jsonData;
          ...
          filterArray: function (t, a, n) {
            ...
            if (
              ((n = n.toUpperCase()), -1 === e.inArray(n, ["AND", "OR", "NOT"]))
            )
              return [];
          ...
          resetScroll: function () {
            void 0 === t.detail &&
              1 === n.getDepth() &&
              (e(a.table).find(".m-datatable__row").css("left", 0),
          ...
          getDefaultSortColumn: function () {
            var a = { sort: "", field: "" };
            return (
              e.each(t.columns, function (t, n) {
                if (
                  void 0 !== n.sortable &&
                  -1 !== e.inArray(n.sortable, ["asc", "desc"])
                )
        ...
        var o = {
          ...
          reload: function () {
            return (
              (function (e, t) {
                ...
                !1 === t.data.serverFiltering && n.localDataUpdate(),
                  n.dataRender(),
              ...
              e(a.tableBody)
                ...
                .each(function (o, i) {
                  if (t == e(i).text()) {
                    ...
                    return (
                      (a.API.record = a.API.value =
                        n.getOneRow(a.tableBody, l)),
                      a
                    );
                  }
                }),
          ...
          getColumn: function (t) {
            return (
              (a.API.column = a.API.value =
                e(a.API.record).find('[data-field="' + t + '"]')),
              a
            );
          },
          destroy: function () {
            return (
              ...
              e(a).replaceWith(
                e(a.old).addClass("m-datatable--destroyed").show()
              ),
              e(a).trigger("m-datatable--on-destroy"),
              a
            );
          },
          sort: function (t, n) {
            return (
              void 0 === n && (n = "asc"),
              e(a.tableHead)
                .find('.m-datatable__cell[data-field="' + t + '"]')
                .trigger("click"),
              a
            );
          },
          ...
          setActive: function (t) {
            "string" == typeof t &&
              (t = e(a.tableBody).find(
                '.m-checkbox--single > [type="checkbox"][value="' + t + '"]'
              )),
              e(t).prop("checked", !0);
            var n = e(t)
                .closest(".m-datatable__row")
          ...
          setSelectedRecords: function () {
            return (
              (a.API.record = e(a.tableBody).find(".m-datatable__row--active")),
              a
            );
          },
          ...
          setDataSourceParam: function (t, i) {
            ...
            (a.API.params = e.extend(
              ...
              (a.API.params = n.extendObj(a.API.params, t, i)),
        ...
        return (
          ...
          "string" == typeof t
            ...
            : ((a.textAlign = {
              ...
              e(a).data("options", t),
              e(a).trigger("m-datatable--on-init", t),
              n.init.apply(this, [t])),
          a
        );
      }
  ...
  (function (e) {
    (e.fn.mDropdown = function (t) {
        ...
        o = {
          run: function (e) {
            return (
              n.data("dropdown")
                ? (a = n.data("dropdown"))
                : (o.init(e), o.build(), o.setup(), n.data("dropdown", a)),
              a
            );
          },
          init: function (t) {
            (a.events = []),
              (a.eventOne = !1),
              (a.close = n.find(".m-dropdown__close")),
              (a.toggle = n.find(".m-dropdown__toggle")),
              (a.arrow = n.find(".m-dropdown__arrow")),
              (a.wrapper = n.find(".m-dropdown__wrapper")),
              (a.scrollable = n.find(".m-dropdown__scrollable")),
              (a.defaultDropPos = n.hasClass("m-dropdown--up") ? "up" : "down"),
              (a.currentDropPos = a.defaultDropPos),
              (a.options = e.extend(!0, {}, e.fn.mDropdown.defaults, t)),
              !0 === n.data("drop-auto")
                ? (a.options.dropAuto = !0)
                : !1 === n.data("drop-auto") && (a.options.dropAuto = !1),
              a.scrollable.length > 0 &&
                (a.scrollable.data("min-height") &&
                  (a.options.minHeight = a.scrollable.data("min-height")),
                a.scrollable.data("max-height") &&
                  (a.options.maxHeight = a.scrollable.data("max-height")));
          },
          build: function () {
            mUtil.isMobileDevice()
              ? "hover" == n.data("dropdown-toggle") ||
                "click" == n.data("dropdown-toggle")
                ? (a.options.toggle = "click")
                : ((a.options.toggle = "click"), a.toggle.click(o.toggle))
              : "hover" == n.data("dropdown-toggle")
              ? ((a.options.toggle = "hover"), n.mouseleave(o.hide))
              : "click" == n.data("dropdown-toggle")
              ? (a.options.toggle = "click")
              : "hover" == a.options.toggle
              ? (n.mouseenter(o.show), n.mouseleave(o.hide))
              : a.toggle.click(o.toggle),
              a.close.length && a.close.on("click", o.hide),
              o.disableClose();
          },
          setup: function () {
            a.options.placement &&
              n.addClass("m-dropdown--" + a.options.placement),
              a.options.align &&
                n.addClass("m-dropdown--align-" + a.options.align),
              a.options.width && a.wrapper.css("width", a.options.width),
              n.data("dropdown-persistent") && (a.options.persistent = !0),
              a.options.minHeight &&
                a.scrollable.css("min-height", a.options.minHeight),
              a.options.maxHeight &&
                (a.scrollable.css("max-height", a.options.maxHeight),
                a.scrollable.css("overflow-y", "auto"),
                mUtil.isDesktopDevice() && mApp.initScroller(a.scrollable, {})),
              o.setZindex();
          },
          sync: function () {
            e(n).data("dropdown", a);
          ...
          disableClose: function () {
            n.on(
              "click",
              ".m-dropdown--disable-close, .mCSB_1_scrollbar",
              function (e) {
          ...
          show: function () {
            if ("hover" == a.options.toggle && n.data("hover"))
              return o.clearHovered(), a;
            if (a.open) return a;
            if (
              (a.arrow.length > 0 && o.adjustArrowPos(),
              o.eventTrigger("beforeShow"),
              o.hideOpened(),
              n.addClass("m-dropdown--open"),
          ...
          hideClicked: function () {
            !1 !== o.eventTrigger("beforeHide") &&
              (n.removeClass("m-dropdown--open"),
              n.data("dropoff") && n.data("dropoff").remove(),
              (a.open = !1),
              o.eventTrigger("afterHide"));
          },
          hide: function (e) {
            return !1 === a.open
              ...
              : ("hover" == a.options.toggle
                  ? o.hideHovered(e)
                  : o.hideClicked(),
                "down" == a.defaultDropPos &&
                  "up" == a.currentDropPos &&
                  (n.removeClass("m-dropdown--up"),
                  a.arrow.prependTo(a.wrapper),
          ...
          adjustArrowPos: function () {
            var e = n.outerWidth(),
              t = a.arrow.hasClass("m-dropdown__arrow--right")
                ? "right"
                : "left",
              o = 0;
            a.arrow.length > 0 &&
              (mUtil.isInResponsiveRange("mobile") &&
              n.hasClass("m-dropdown--mobile-full-width")
                ? ((o =
                    n.offset().left +
                    e / 2 -
                    Math.abs(a.arrow.width() / 2) -
                    parseInt(a.wrapper.css("left"))),
                  a.arrow.css("right", "auto"),
                  a.arrow.css("left", o),
                  a.arrow.css("margin-left", "auto"),
                  a.arrow.css("margin-right", "auto"))
                : a.arrow.hasClass("m-dropdown__arrow--adjust") &&
                  ((o = e / 2 - Math.abs(a.arrow.width() / 2)),
                  n.hasClass("m-dropdown--align-push") && (o += 20),
                  "right" == t
                    ? (a.arrow.css("left", "auto"), a.arrow.css("right", o))
                    : (a.arrow.css("right", "auto"), a.arrow.css("left", o))));
          },
          ...
          isInVerticalViewport: function () {
            ...
            return (
              i.length &&
                (i.data("max-height")
                  ? (o += parseInt(i.data("max-height")))
                  : i.data("height") && (o += parseInt(i.data("height")))),
              n.top + o < e(window).scrollTop() + e(window).height()
            );
          },
          eventTrigger: function (e) {
            for (i = 0; i < a.events.length; i++) {
              ...
              if (t.name == e) {
                ...
                if (0 == t.fired)
                  return (a.events[i].fired = !0), t.handler.call(this, a);
              }
            }
          },
      ...
      mUtil.isMobileDevice()
        ? e(document).on(
            "click",
            '[data-dropdown-toggle="click"] .m-dropdown__toggle, [data-dropdown-toggle="hover"] .m-dropdown__toggle',
            function (t) {
              t.preventDefault(),
                e(this).parent(".m-dropdown").mDropdown().toggle();
            }
          )
        : (e(document).on(
            "click",
            '[data-dropdown-toggle="click"] .m-dropdown__toggle',
            function (t) {
              t.preventDefault(),
                e(this).parent(".m-dropdown").mDropdown().toggle();
            }
        ...
        o = {
          run: function (e) {
            return (
              n.data("example")
                ? (a = n.data("example"))
                : (o.init(e), o.build(), o.setup(), n.data("example", a)),
              a
            );
          },
          init: function (t) {
            (a.events = []),
              (a.scrollable = n.find(".m-example__scrollable")),
              (a.options = e.extend(!0, {}, e.fn.mExample.defaults, t)),
              a.scrollable.length > 0 &&
                (a.scrollable.data("data-min-height") &&
                  (a.options.minHeight = a.scrollable.data("data-min-height")),
                a.scrollable.data("data-max-height") &&
                  (a.options.maxHeight = a.scrollable.data("data-max-height")));
          },
          build: function () {
            mUtil.isMobileDevice();
          },
        ...
        o = {
          run: function (e) {
            return (
              n.data("header")
                ? (a = n.data("header"))
                : (o.init(e), o.reset(), o.build(), n.data("header", a)),
              a
            );
          },
          init: function (t) {
            ...
            (!1 === a.options.minimize.mobile &&
              ...
              e(window).scroll(function () {
                ...
                mUtil.isInResponsiveRange("desktop")
                  ? ((n = a.options.offset.desktop),
                    (on = a.options.minimize.desktop.on),
                    (off = a.options.minimize.desktop.off))
                  : mUtil.isInResponsiveRange("tablet-and-mobile") &&
                    ((n = a.options.offset.mobile),
                    (on = a.options.minimize.mobile.on),
                    (off = a.options.minimize.mobile.off));
                var o = e(this).scrollTop();
                a.options.classic
                  ? o > n
                    ? (e("body").addClass(on), e("body").removeClass(off))
                    : (e("body").addClass(off), e("body").removeClass(on))
                  : (o > n && t < o
                      ? (e("body").addClass(on), e("body").removeClass(off))
                      : (e("body").addClass(off), e("body").removeClass(on)),
                    (t = o));
  ...
  (function (e) {
    (e.fn.mMenu = function (t) {
        ...
        o = {
          run: function (e, t) {
            return (
              n.data("menu") && !0 !== t
                ? (a = n.data("menu"))
                : (o.init(e), o.reset(), o.build(), n.data("menu", a)),
              a
            );
          },
          init: function (t) {
            (a.events = []),
              (a.options = e.extend(!0, {}, e.fn.mMenu.defaults, t)),
              (a.pauseDropdownHoverTime = 0);
          },
          build: function () {
            "accordion" === o.getSubmenuMode() &&
              n.on("click", ".m-menu__toggle", o.handleSubmenuAccordion),
              ("dropdown" === o.getSubmenuMode() ||
                o.isConditionalSubmenuDropdown()) &&
                (n.on(
                  {
                ...
                n.on(
                  "click",
                  '[data-menu-submenu-toggle="click"] .m-menu__toggle',
                  o.handleSubmenuDropdownClick
                )),
              n
                .find(
                  ".m-menu__item:not(.m-menu__item--submenu) > .m-menu__link:not(.m-menu__toggle)"
                )
                .click(o.handleLinkClick);
          },
          reset: function () {
            n.off("click", ".m-menu__toggle", o.handleSubmenuAccordion),
              n.off(
                {
                  mouseenter: o.handleSubmenuDrodownHoverEnter,
                  mouseleave: o.handleSubmenuDrodownHoverExit,
              ...
              a.find(".m-menu__submenu, .m-menu__inner").css("display", ""),
              a.find(".m-menu__item--hover").removeClass("m-menu__item--hover"),
              a
                .find(".m-menu__item--open:not(.m-menu__item--expanded)")
          ...
          getSubmenuMode: function () {
            return mUtil.isInResponsiveRange("desktop")
              ? mUtil.isset(a.options.submenu, "desktop.state.body")
                ? e("body").hasClass(a.options.submenu.desktop.state.body)
          ...
          handleLinkClick: function (t) {
            !1 === o.eventTrigger("linkClick", e(this)) && t.preventDefault(),
              ("dropdown" === o.getSubmenuMode() ||
                o.isConditionalSubmenuDropdown()) &&
                o.handleSubmenuDropdownClose(t, e(this));
          },
          handleSubmenuDrodownHoverEnter: function (t) {
            if (
              ...
              var n = e(this);
              o.showSubmenuDropdown(n),
                1 == n.data("hover") && o.hideSubmenuDropdown(n, !1);
            }
          },
          ...
          handleSubmenuDropdownClick: function (t) {
            if ("accordion" !== o.getSubmenuMode()) {
              ...
              0 == a.hasClass("m-menu__item--hover")
                ? (a.addClass("m-menu__item--open-dropdown"),
                  o.showSubmenuDropdown(a))
                : (a.removeClass("m-menu__item--open-dropdown"),
                  o.hideSubmenuDropdown(a, !0)),
                t.preventDefault();
            }
          },
          handleSubmenuDropdownClose: function (t, a) {
            if ("accordion" !== o.getSubmenuMode()) {
              ...
              i.length > 0 &&
                !1 === a.hasClass("m-menu__toggle") &&
                0 === a.find(".m-menu__toggle").length &&
                i.each(function () {
              ...
              if ((l.parent(".m-menu__item--expanded").length, l.length > 0)) {
                ...
                if (!1 === i.hasClass("m-menu__item--open")) {
                  if (!1 === a.options.accordion.expandAll) {
                    var s = n
                      .closest(".m-menu__nav, .m-menu__subnav")
                      .find(
                        "> .m-menu__item.m-menu__item--open.m-menu__item--submenu:not(.m-menu__item--expanded)"
                      );
                    s.each(function () {
                      e(this)
          ...
          scrollToItem: function (e) {
            mUtil.isInResponsiveRange("desktop") &&
              ...
              !n.data("menu-scrollable") &&
              mApp.scrollToViewport(e);
          },
          ...
          showSubmenuDropdown: function (t) {
            n
              .find(".m-menu__item--submenu.m-menu__item--hover")
              .each(function () {
                var a = e(this);
                t.is(a) ||
                  a.find(t).length > 0 ||
              ...
              o.adjustSubmenuDropdownArrowPos(t),
              t.addClass("m-menu__item--hover"),
              "accordion" === o.getSubmenuMode() &&
                a.options.accordion.autoScroll &&
                mApp.scrollTo(t.children(".m-menu__item--submenu"));
          },
          resize: function (t) {
            if ("dropdown" === o.getSubmenuMode()) {
              var i,
                l = n.find("> .m-menu__nav > .m-menu__item--resize"),
              ...
              if (
                "dropdown" == o.getSubmenuMode() &&
                ((mUtil.isInResponsiveRange("desktop") &&
                  mUtil.isset(a.options, "resize.desktop") &&
                  (i = a.options.resize.desktop) &&
                  s <= l.data("menu-resize-desktop-breakpoint")) ||
                  (mUtil.isInResponsiveRange("tablet") &&
                    mUtil.isset(a.options, "resize.tablet") &&
                    (i = a.options.resize.tablet) &&
                    s <= l.data("menu-resize-tablet-breakpoint")) ||
                  (mUtil.isInResponsiveRange("mobile") &&
                    mUtil.isset(a.options, "resize.mobile") &&
                    (i = a.options.resize.mobile) &&
                    s <= l.data("menu-resize-mobile-breakpoint")))
              ) {
                var d = r.find("> .m-menu__subnav > .m-menu__item").length,
                  c = n.find(
                    "> .m-menu__nav > .m-menu__item:not(.m-menu__item--resize)"
                  ).length;
                if (!0 === i.apply())
                  d > 0 &&
                    r
                      .find("> .m-menu__subnav > .m-menu__item")
                      .each(function () {
                        var t = e(this),
                          a = r.find(
                            "> .m-menu__nav > .m-menu__item:not(.m-menu__item--resize)"
                        ...
                        if (
                          ...
                          return t.appendTo(r.find("> .m-menu__subnav")), !1;
                        d--, c++;
                      });
                else if (c > 0)
                  for (
                ...
                r.find("> .m-menu__subnav > .m-menu__item").each(function () {
                  var t = r.find("> .m-menu__subnav > .m-menu__item").length;
                  n.find("> .m-menu__nav > .m-menu__item")
                    .get(t)
                    .after(e(this));
                }),
                  l.hide();
          ...
          createSubmenuDropdownClickDropoff: function (t) {
            ...
            e("body").after(n),
              n.on("click", function (a) {
                a.stopPropagation(),
                  a.preventDefault(),
                  t.removeClass("m-menu__item--hover"),
                  e(this).remove();
              });
          },
          adjustSubmenuDropdownArrowPos: function (e) {
            var t = e.find(
                "> .m-menu__submenu > .m-menu__arrow.m-menu__arrow--adjust"
              ),
            ...
            if (t.length > 0) {
              ...
              a.hasClass("m-menu__submenu--classic") ||
              a.hasClass("m-menu__submenu--fixed")
                ? a.hasClass("m-menu__submenu--right")
                  ? ((n = e.outerWidth() / 2),
                    a.hasClass("m-menu__submenu--pull") &&
                      (n += Math.abs(parseInt(a.css("margin-right")))),
                    (n = a.width() - n))
                  : a.hasClass("m-menu__submenu--left") &&
                    ((n = e.outerWidth() / 2),
                    a.hasClass("m-menu__submenu--pull") &&
                      (n += Math.abs(parseInt(a.css("margin-left")))))
                : a.hasClass("m-menu__submenu--center") ||
                  a.hasClass("m-menu__submenu--full")
                ? ((n =
                    e.offset().left -
                    (mUtil.getViewPort().width - a.outerWidth()) / 2),
                  (n += e.outerWidth() / 2))
                : a.hasClass("m-menu__submenu--left") ||
                  a.hasClass("m-menu__submenu--right"),
                t.css("left", n);
          ...
          resetActiveItem: function (t) {
            n.find(".m-menu__item--active").each(function () {
              e(this).removeClass("m-menu__item--active"),
                e(this).children(".m-menu__submenu").css("display", ""),
                e(this)
                  .parents(".m-menu__item--submenu")
                  .each(function () {
                    e(this).removeClass("m-menu__item--open"),
                      e(this).children(".m-menu__submenu").css("display", "");
                  });
              ...
              !1 === a.options.accordion.expandAll &&
                n.find(".m-menu__item--open").each(function () {
                  e(this).removeClass("m-menu__item--open");
                });
          },
          setActiveItem: function (t) {
            o.resetActiveItem(),
              (t = e(t)).addClass("m-menu__item--active"),
          ...
          getPageTitle: function (t) {
            return (t = e(t))
              .children(".m-menu__link")
              .find(".m-menu__link-text")
              .html();
          },
          sync: function () {
            e(n).data("menu", a);
          ...
          eventTrigger: function (e, t) {
            for (i = 0; i < a.events.length; i++) {
              ...
              if (n.name == e) {
                ...
                if (0 == n.fired)
                  return (a.events[i].fired = !0), n.handler.call(this, a, t);
              }
            }
          },
          addEvent: function (e, t, n) {
      ...
      (e.fn.mMenu.defaults = {
        accordion: { slideSpeed: 200, autoScroll: !0, expandAll: !0 },
        dropdown: { timeout: 500 },
      }),
      e(document).on("click", function (t) {
        e(
          '.m-menu__nav .m-menu__item.m-menu__item--submenu.m-menu__item--hover[data-menu-submenu-toggle="click"]'
        ).each(function () {
          var a = e(this).parent(".m-menu__nav").parent();
          (menu = a.mMenu()),
            "dropdown" === menu.getSubmenuMode() &&
              0 == e(t.target).is(a) &&
              0 == a.find(e(t.target)).length &&
              a
                .find(
                  '.m-menu__item--submenu.m-menu__item--hover[data-menu-submenu-toggle="click"]'
                )
                .removeClass("m-menu__item--hover");
        });
      });
  })(jQuery),
  (function (e) {
        ...
        o = {
          run: function (e) {
            return (
              n.data("messenger")
                ? (a = n.data("messenger"))
                : (o.init(e), o.build(), o.setup(), n.data("messenger", a)),
              a
            );
          },
          init: function (t) {
            (a.events = []),
              (a.scrollable = n.find(".m-messenger__scrollable")),
              (a.options = e.extend(!0, {}, e.fn.mMessenger.defaults, t)),
              a.scrollable.length > 0 &&
                (a.scrollable.data("data-min-height") &&
                  (a.options.minHeight = a.scrollable.data("data-min-height")),
                a.scrollable.data("data-max-height") &&
        ...
        o = {
          run: function (e) {
            return (
              n.data("offcanvas")
                ? (a = n.data("offcanvas"))
                : (o.init(e), o.build(), n.data("offcanvas", a)),
              a
            );
          },
          init: function (t) {
            (a.events = []),
              (a.options = e.extend(!0, {}, e.fn.mOffcanvas.defaults, t)),
              a.overlay,
              (a.classBase = a.options.class),
              (a.classShown = a.classBase + "--on"),
              (a.classOverlay = a.classBase + "-overlay"),
              (a.state = n.hasClass(a.classShown) ? "shown" : "hidden"),
              (a.close = a.options.close),
              a.options.toggle && a.options.toggle.target
                ? ((a.toggleTarget = a.options.toggle.target),
                  (a.toggleState = a.options.toggle.state))
                : ((a.toggleTarget = a.options.toggle), (a.toggleState = ""));
          },
          build: function () {
            e(a.toggleTarget).on("click", o.toggle),
              a.close && e(a.close).on("click", o.hide);
          },
          sync: function () {
          ...
          show: function () {
            if ("shown" != a.state) {
              if (
                (o.eventTrigger("beforeShow"),
                "" != a.toggleState &&
                  e(a.toggleTarget).addClass(a.toggleState),
                e("body").addClass(a.classShown),
                n.addClass(a.classShown),
                (a.state = "shown"),
                a.options.overlay)
              ) {
          ...
          hide: function () {
            if ("hidden" != a.state)
              return (
                ...
                "" != a.toggleState &&
                  e(a.toggleTarget).removeClass(a.toggleState),
                e("body").removeClass(a.classShown),
                n.removeClass(a.classShown),
                (a.state = "hidden"),
                a.options.overlay && a.overlay.remove(),
                o.eventTrigger("afterHide"),
                a
              );
          },
    ...
    (e.fn.mPortlet = function (t) {
      var a = {},
        ...
        o = {
          run: function (e) {
            return (
              n.data("portlet-object")
                ? (a = n.data("portlet-object"))
                : (o.init(e), o.build(), n.data("portlet-object", a)),
              a
            );
          },
          init: function (t) {
            (a.options = e.extend(!0, {}, e.fn.mPortlet.defaults, t)),
              (a.events = []),
              (a.eventOne = !1),
              0 !== n.find("> .m-portlet__body").length
                ? (a.body = n.find("> .m-portlet__body"))
                : 0 !== n.find("> .m-form").length &&
                  (a.body = n.find("> .m-form"));
          },
          build: function () {
          ...
          remove: function () {
            !1 !== o.eventTrigger("beforeRemove") &&
              (e("body").hasClass("m-portlet--fullscreen") &&
                n.hasClass("m-portlet--fullscreen") &&
                o.fullscreen("off"),
              o.removeTooltips(),
              n.remove(),
              o.eventTrigger("afterRemove"));
          },
          setContent: function (e) {
            e && a.body.html(e);
          },
          ...
          setupTooltips: function () {
            if (a.options.tooltips) {
              ...
              1 === i.length &&
                (i.attr("title", a.options.tools.remove),
                i.data("placement", o ? "bottom" : "top"),
                i.data("offset", o ? "0,10px,0,0" : "0,5px"),
                i.tooltip("dispose"),
                mApp.initTooltip(i));
              var l = n.find("> .m-portlet__head [data-portlet-tool=reload]");
              1 === l.length &&
                (l.attr("title", a.options.tools.reload),
                l.data("placement", o ? "bottom" : "top"),
                l.data("offset", o ? "0,10px,0,0" : "0,5px"),
                l.tooltip("dispose"),
                mApp.initTooltip(l));
              var r = n.find("> .m-portlet__head [data-portlet-tool=toggle]");
              1 === r.length &&
                (t
                  ? r.attr("title", a.options.tools.toggle.expand)
                  : r.attr("title", a.options.tools.toggle.collapse),
                r.data("placement", o ? "bottom" : "top"),
                r.data("offset", o ? "0,10px,0,0" : "0,5px"),
                r.tooltip("dispose"),
                mApp.initTooltip(r));
              var s = n.find(
                "> .m-portlet__head [data-portlet-tool=fullscreen]"
              );
              1 === s.length &&
                (o
                  ? s.attr("title", a.options.tools.fullscreen.off)
                  : s.attr("title", a.options.tools.fullscreen.on),
                s.data("placement", o ? "bottom" : "top"),
                s.data("offset", o ? "0,10px,0,0" : "0,5px"),
                s.tooltip("dispose"),
                mApp.initTooltip(s));
            }
          },
          ...
          toggle: function (e) {
            if (
              "collapse" === e ||
              n.hasClass("m-portlet--collapse") ||
              n.hasClass("m-portlet--collapsed")
            ) {
              if (!1 === o.eventTrigger("beforeExpand")) return;
              n.removeClass("m-portlet--collapse"),
                n.removeClass("m-portlet--collapsed"),
                o.setupTooltips(),
                a.body.slideDown(a.options.bodyToggleSpeed, function () {
                  o.eventTrigger("afterExpand");
                });
            } else {
              if (!1 === o.eventTrigger("beforeCollapse")) return;
              n.addClass("m-portlet--collapse"),
                o.setupTooltips(),
                a.body.slideUp(a.options.bodyToggleSpeed, function () {
          ...
          fullscreen: function (t) {
            ...
            (e("body").hasClass("m-portlet--fullscreen") &&
              n.hasClass("m-portlet--fullscreen"))
              ? (o.eventTrigger("beforeFullscreenOff"),
                e("body").removeClass("m-portlet--fullscreen"),
                n.removeClass("m-portlet--fullscreen"),
                o.setupTooltips(),
                o.eventTrigger("afterFullscreenOff"))
              : (o.eventTrigger("beforeFullscreenOn"),
                n.addClass("m-portlet--fullscreen"),
                e("body").addClass("m-portlet--fullscreen"),
                o.setupTooltips(),
        ...
        o = {
          run: function (e) {
            return (
              n.data("qs")
                ? (a = n.data("qs"))
                : (o.init(e), o.build(), n.data("qs", a)),
              a
            );
          },
          init: function (t) {
            (a.options = e.extend(!0, {}, e.fn.mQuicksearch.defaults, t)),
              (a.form = n.find("form")),
              (a.input = e(a.options.input)),
              (a.iconClose = e(a.options.iconClose)),
              "default" == a.options.type &&
                ((a.iconSearch = e(a.options.iconSearch)),
                (a.iconCancel = e(a.options.iconCancel))),
              (a.dropdown = n.mDropdown({ mobileOverlay: !1 })),
              a.cancelTimeout,
              (a.processing = !1);
          },
          build: function () {
            a.input.keyup(o.handleSearch),
              "default" == a.options.type
                ? (a.input.focus(o.showDropdown),
                  a.iconCancel.click(o.handleCancel),
                  a.iconSearch.click(function () {
                    mUtil.isInResponsiveRange("tablet-and-mobile") &&
                      (e("body").addClass("m-header-search--mobile-expanded"),
                      a.input.focus());
                  }),
          ...
          handleSearch: function (t) {
            ...
            0 === i.length &&
              (a.dropdown.hide(),
              o.handleCancelIconVisibility("on"),
              o.closeDropdown(),
              n.removeClass(a.options.hasResultClass)),
              i.length < a.options.minLength ||
                1 == a.processing ||
                ((a.processing = !0),
                a.form.addClass(a.options.spinner),
                o.handleCancelIconVisibility("off"),
                e.ajax({
                  ...
                  success: function (e) {
                    (a.processing = !1),
                      a.form.removeClass(a.options.spinner),
                      o.handleCancelIconVisibility("on"),
                      a.dropdown.setContent(e).show(),
                      n.addClass(a.options.hasResultClass);
                  },
                  error: function (e) {
                    (a.processing = !1),
                      a.form.removeClass(a.options.spinner),
                      o.handleCancelIconVisibility("on"),
                      a.dropdown
                        .setContent(a.options.templates.error.apply(a, e))
                        .show(),
                      n.addClass(a.options.hasResultClass);
                  },
                }));
          ...
          handleCancelIconVisibility: function (e) {
            "dropdown" != a.options.type &&
              ("on" == e
                ? 0 === a.input.val().length
                  ? (a.iconCancel.css("visibility", "hidden"),
                    a.iconClose.css("visibility", "hidden"))
                  : (clearTimeout(a.cancelTimeout),
                    (a.cancelTimeout = setTimeout(function () {
                      a.iconCancel.css("visibility", "visible"),
                        a.iconClose.css("visibility", "visible");
                    }, 500)))
                : (a.iconCancel.css("visibility", "hidden"),
                  a.iconClose.css("visibility", "hidden")));
          },
          ...
          showDropdown: function (e) {
            0 == a.dropdown.isShown() &&
              a.input.val().length > a.options.minLength &&
              0 == a.processing &&
              (a.dropdown.show(), e.preventDefault(), e.stopPropagation());
          },
        };
        ...
        o = {
          run: function (e) {
            return (
              n.data("scrollTop")
                ? (a = n.data("scrollTop"))
                : (o.init(e), o.build(), n.data("scrollTop", a)),
              a
            );
          },
          init: function (t) {
            (a.element = n),
              (a.events = []),
              (a.options = e.extend(!0, {}, e.fn.mScrollTop.defaults, t));
          },
          build: function () {
            navigator.userAgent.match(/iPhone|iPad|iPod/i)
              ? e(window).bind("touchend touchcancel touchleave", function () {
                  o.handle();
                })
              : e(window).scroll(function () {
                  o.handle();
          ...
          handle: function () {
            e(window).scrollTop() > a.options.offset
              ? e("body").addClass("m-scroll-top--shown")
              : e("body").removeClass("m-scroll-top--shown");
          },
          scroll: function (t) {
            t.preventDefault(),
              e("html, body").animate({ scrollTop: 0 }, a.options.speed);
          },
          eventTrigger: function (e) {
            for (i = 0; i < a.events.length; i++) {
              var t = a.events[i];
        ...
        o = {
          run: function (e) {
            return (
              n.data("toggle")
                ? (a = n.data("toggle"))
                : (o.init(e), o.build(), n.data("toggle", a)),
              a
            );
          },
          init: function (t) {
            (a.element = n),
              (a.events = []),
              (a.options = e.extend(!0, {}, e.fn.mToggle.defaults, t)),
              (a.target = e(a.options.target)),
          ...
          on: function () {
            return (
              ...
              a.target.addClass(a.targetState),
              a.togglerState && n.addClass(a.togglerState),
              (a.state = "on"),
          ...
          off: function () {
            return (
              ...
              a.target.removeClass(a.targetState),
              a.togglerState && n.removeClass(a.togglerState),
              (a.state = "off"),
  ...
  (Chart.elements.Rectangle.prototype.draw = function () {
    ...
    if (
      (c.horizontal
        ? ((t = c.base),
          ...
          (i = a > t ? 1 : -1),
          (l = 1),
          (r = c.borderSkipped || "left"))
        : ((t = c.x - c.width / 2),
          (a = c.x + c.width / 2),
          (n = c.y > 2 * m ? c.y - m : c.y),
          (i = 1),
          (l = (o = c.base) > n ? 1 : -1),
          (r = c.borderSkipped || "bottom")),
      u)
    ) {
    ...
    var _ = [
      ...
      w = ["bottom", "left", "top", "right"].indexOf(r, 0);
    -1 === w && (w = 0);
    var k = e(0);
    d.moveTo(k[0], k[1]);
    for (var C = 1; C < 4; C++)
      (k = e(C)),
        ...
        (nextCorner = e(nextCornerId)),
        (width = _[2][0] - _[1][0]),
        (height = _[0][1] - _[1][1]),
        (x = _[1][0]),
        (y = _[1][1]),
        (s = m) > height / 2 && (s = height / 2),
        s > width / 2 && (s = width / 2),
        d.moveTo(x + s, y),
        d.lineTo(x + width - s, y),
        d.quadraticCurveTo(x + width, y, x + width, y + s),
        d.lineTo(x + width, y + height - s),
        d.quadraticCurveTo(x + width, y + height, x + width - s, y + height),
        d.lineTo(x + s, y + height),
        d.quadraticCurveTo(x, y + height, x, y + height - s),
        d.lineTo(x, y + s),
        d.quadraticCurveTo(x, y, x + s, y);
    d.fill(), u && d.stroke();
  }),
  ...
  jQuery.validator.setDefaults({
    ...
    success: function (e, t) {
      $(e)
        ...
        $(e).closest(".form-group").find(".form-control-feedback").remove();
    },
  });
var mLayout = (function () {
  var e,
    ...
    o = function () {
      var e = $(".m-header"),
        t = { offset: {}, minimize: {} };
      "hide" == e.data("minimize-mobile")
        ? ((t.minimize.mobile = {}),
          (t.minimize.mobile.on = "m-header--hide"),
          (t.minimize.mobile.off = "m-header--show"))
        : (t.minimize.mobile = !1),
        "hide" == e.data("minimize")
          ? ((t.minimize.desktop = {}),
            (t.minimize.desktop.on = "m-header--hide"),
            (t.minimize.desktop.off = "m-header--show"))
          : (t.minimize.desktop = !1),
        e.data("minimize-offset") &&
          (t.offset.desktop = e.data("minimize-offset")),
        e.data("minimize-mobile-offset") &&
          (t.offset.mobile = e.data("minimize-mobile-offset")),
        e.mHeader(t);
    },
    i = function () {
        ...
        (e = $("#m_header_menu").mMenu({
          ...
          resize: {
            desktop: function () {
              ...
              return !(
                $("#m_header_menu_container").width() +
                  $("#m_header_topbar").width() +
                  20 >
                e
              );
            },
      ...
      function e(e) {
        if (mUtil.isInResponsiveRange("tablet-and-mobile"))
          ...
          var t =
            ...
            (0 != $(".m-aside-left .m-aside__header").length
              ? $(".m-aside-left .m-aside__header").outerHeight()
              : 0) -
            (0 != $(".m-aside-left .m-aside__footer").length
    ...
    r = function () {
      var e = $("#m_aside_left").hasClass("m-aside-left--offcanvas-default")
    ...
    c = function () {
      ...
      e.mQuicksearch({
        ...
        source:
          "http://keenthemes.com/metronic/preview/inc/api/quick_search.php",
...
var mQuickSidebar = (function () {
  var e = $("#m_quick_sidebar"),
    ...
    d = function () {
      e.mOffcanvas({ class: "m-quick-sidebar", close: a, toggle: n }),
