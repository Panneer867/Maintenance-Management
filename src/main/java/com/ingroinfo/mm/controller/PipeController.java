...
public class PipeController {
	...
	public String maintenanceInspection(Model model) {
		List<PipeMaintenanceUpdateDto> listofPipeMaintenUpdateDtos = this.pipeMaintenanceService.findAllPipeMaintenanceUpdate();
	...
	public String getPipeMaintenanceUpdate(@PathVariable("pipeUpdateId") Long pipeUpdateId, Model model) {
		PipeMaintenanceUpdateDto pipeMaintenanceUpdateDto = this.pipeMaintenanceService.getPipeMaintenanceUpdateById(pipeUpdateId);
	...
	public String savePipeMaintenanceInspection(PipeMaintenanceInspectionDto pipeMaintenanceInspectionDto,HttpSession session) {
